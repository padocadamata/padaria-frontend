...
// YYYY-MM-DD, devolvendo outra data pura YYYY-MM-DD — sem nenhuma
// conversão de fuso (mesmo truque de meio-dia local de diaDaSemanaExibicao
// acima: construir/ler os componentes em hora local, nunca via
// toISOString()/getUTC*, que usariam UTC e poderiam empurrar para o dia
// errado). Usado pelo Controle de Expositores (0030) para calcular
// "amanhã" a partir de dataLocalHoje(), nunca via new Date() cru.
