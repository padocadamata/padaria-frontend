...
export function mensagemErroLoteExpositor(error) {
  ...
  if (msg.includes('somente aberto ou fechado')) {
    return 'Este lançamento foi reaberto para correção -- não é possível criar um novo lote de expositor enquanto ele estiver reaberto. Atualize a página.';
  }
