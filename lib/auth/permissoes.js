...
export const PERMISSOES = {
  ...
  // nesta etapa do frontend (listagem + criação) só visualizar/inserir têm
  // uso — receber/cancelar/editar ficam para as próximas fases, quando a
  // UI que os consome existir.
